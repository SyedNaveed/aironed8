...
";
        // line 3
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, twig_var_dump($this->env, $context, [0 => twig_get_array_keys_filter($this->sandbox->ensureToStringAllowed(($context["data"] ?? null)))]), "html", null, true);
        echo "
<div class=\"row\">
    <div class=\"col-6\">
        ";
        // line 6
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["data"] ?? null), "form", [])), "html", null, true);
        echo "
    </div>
    <div class=\"col-6\">
        ";
