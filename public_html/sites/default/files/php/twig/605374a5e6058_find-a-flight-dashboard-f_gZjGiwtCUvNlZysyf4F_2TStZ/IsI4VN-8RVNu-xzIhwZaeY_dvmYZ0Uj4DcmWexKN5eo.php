...
class __TwigTemplate_e034a85c74440409f6bb2681039a88f1baea9b8f3103bd586d854ab227dbca98 extends \Twig\Template
{
  ...
  <div>
    ...
    ";
        // line 13
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, twig_get_array_keys_filter($this->sandbox->ensureToStringAllowed(($context["form"] ?? null))), "html", null, true);
        echo "
    <h3>Other variables</h3>
    ";
        // line 15
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, twig_get_array_keys_filter($this->sandbox->ensureToStringAllowed($context)), "html", null, true);
        echo "
  </div>
