...
class __TwigTemplate_e034a85c74440409f6bb2681039a88f1baea9b8f3103bd586d854ab227dbca98 extends \Twig\Template
{
    public function __construct(Environment $env)
    {
        ...
        $tags = [];
        $filters = ["escape" => 1, "keys" => 13, "without" => 18];
        $functions = ["dump" => 13];
  ...
  <div>
    ...
    ";
        // line 13
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, twig_var_dump($this->env, $context, [0 => twig_get_array_keys_filter($this->sandbox->ensureToStringAllowed(($context["form"] ?? null)))]), "html", null, true);
        echo "
    <h3>Other variables</h3>
    ";
        // line 15
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, twig_var_dump($this->env, $context, [0 => twig_get_array_keys_filter($this->sandbox->ensureToStringAllowed($context))]), "html", null, true);
        echo "
  </div>
  ...
  ";
    ...
    {
        return array (  88 => 18,  82 => 15,  77 => 13,  69 => 8,  63 => 5,  55 => 1,);
    }
