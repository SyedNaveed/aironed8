...
(function ($, Drupal, drupalSettings) {
  ...
  Drupal.behaviors.toolbar = {
    attach: function attach(context) {
      ...
      var isTrayInserted = $(context).find('.toolbar-menu').length > 0 || $(context).hasClass('toolbar-menu');
      if (typeof Drupal.toolbar.views.toolbarVisualView !== 'undefined' && isTrayInserted) {
        Drupal.toolbar.views.toolbarVisualView.model.trigger('change:trayInserted');
      }
...
(function ($, Drupal, drupalSettings, Backbone) {
  Drupal.toolbar.ToolbarVisualView = Backbone.View.extend({
    ...
    initialize: function initialize(options) {
      ...
      this.listenTo(this.model, 'change:activeTab change:orientation change:isOriented change:trayInserted', this.updateToolbarHeight);
